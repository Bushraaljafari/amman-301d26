...
//object studant joe*Student {name: "Joe", age: "Schmoe", hometown: 100}*

// 2. What is "this" when joe.scopeArrow() is invoked?
//window object *window {window: Window, self: Window, document: document, name: "", location: Location,…}
// 3. Explain why "this" is different when an arrow function is used.
//Arrow functions do not bind their own this, instead, they inherit the one from the parent scope (in this case the [window] or the global object..)
